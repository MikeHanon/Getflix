...
if (isset($_POST['username']) && isset($_POST['password1']) && isset($_POST['email']) && $_POST['username']!="" && $_POST['password1']!="" && $_POST['email']!="" ) {
  ...
  if($_POST['password1']==$_POST['password2'] && valid_email($_POST['email']) ) {
    ...
    echo "<p id='errorMsg'>Les deux mdp sont incorret</p>";
  }
...
<div id="main">
    ...
    <form action="inscription.php" method="POST">
            ...
            <input class="input" type="password" placeholder="Mot de passe" name="password1"><br>
            <input class="input" type="password" placeholder="Confirmez votre mot de passe" name="password2"><br>
